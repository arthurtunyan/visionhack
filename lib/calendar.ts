...
export const SCHEDULES: Record<string, ProgrammeSchedule> = {
  ...
  TRL: {
    abbr: "TRL",
    title: "Tobacco retail licence renewal",
    month: 12,
    day: 31,
    everyYears: 1,
    office: "State tax authority",
    note: "Renew before expiry. Selling on a lapsed licence is a separate violation from selling without one.",
  },
  ABC: {
    abbr: "ABC",
    ...
    note: "Pay the renewal fee and confirm the operating conditions attached to the licence still match how you trade.",
  },
  "W&M": {
    abbr: "W&M",
  ...
  BOP: {
    ...
    note: "Renew the site licence and confirm every pharmacist on the roster is current.",
  },
  FIRE: {
    abbr: "FIRE",
