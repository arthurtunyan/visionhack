...
export const OBLIGATIONS: Obligation[] = [
  ...
  },
  {
    ...
    requirements: [
      "Post the licence in plain view",
      "Keep the LEAD server training current",
      "Observe posted sale hours",
      "Check ID on every sale under 40",
    ],
    notes: "ABC renewal runs on the licence anniversary, not the calendar year.",
  },
  {
    key: "tobacco",
    ...
    fields: [
      { key: "stateLicense", label: "State licence number", type: "text" },
      { key: "cityPermitDue", label: "City permit due", type: "date", drivesStatus: true },
    ],
    requirements: [
      "Hold both the state licence and the city permit",
